...
const navStyle = "text-[10px] font-medium text-[#000000] subpixel-antialiased select-none";
        ...
        <div className="relative z-20 flex flex-col flex-1 w-full pointer-events-none h-full">
            <div className="absolute top-20 md:top-[6rem] left-0 w-full px-6 md:px-12 flex flex-col items-start -z-10">
                <div className="w-full max-xl:landscape:max-w-[200px] md:max-w-[420px] xl:max-w-[420px] flex flex-col gap-4 md:gap-8">
                    ...
                    <p className="text-[clamp(7.5px,2.3vw,14px)] max-xl:landscape:text-[9px] md:text-[12px] font-medium text-black leading-[1.5] text-left w-full">
                    ...
                    <p className="text-[clamp(7.5px,2.3vw,14px)] max-xl:landscape:text-[9px] md:text-[12px] font-medium text-black leading-[1.5] opacity-40 md:opacity-60 text-left w-full">
                ...
                <div className="flex flex-col gap-6 pointer-events-auto">
                    <div className="hidden md:flex flex-col">
                        <p className={`${navStyle} leading-[2] font-light text-[#000000]`}>
                            Based in the Philippines, aspiring Creative Developer. <br />
                            Fullstack background, specialized in Frontend Development.
                        </p>
                    </div>

                    <div className="flex flex-col">
                        <span className="text-[10px] md:text-[10px] font-medium text-[#8E8E8A]">
                            © renz cuison
                        </span>
                    </div>
                </div>
